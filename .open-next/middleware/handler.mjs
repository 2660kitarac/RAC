...
Object.defineProperty = function(o, p, a) {
  ...
  globalThis.openNextDebug = false;globalThis.openNextVersion = "4.0.2";globalThis.nextVersion = "15.3.9";
...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 35: (e, t) => {
      ...
      r.r(i), r.d(i, { config: () => tp, middleware: () => td });
      let o = null;
      async function s() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      }, eN = /* @__PURE__ */ new Map(), eI = n.createContextKey("next.rootSpanId"), ek = 0, eM = () => ek++, eA = { set(e10, t2, r2) {
      ...
      let tl = ["__Secure-authjs.session-token", "authjs.session-token", "__Secure-authjs.session-token.0", "authjs.session-token.0"], tu = ["/login", "/register", "/pending", "/reset-password", "/mu/", "/api/clubs/public", "/api/", "/club/"];
      function tc(e10) {
        for (let t3 of tl) {
          let r2 = e10.cookies.get(t3)?.value;
          if (r2 && r2.length > 10) return true;
        }
        let t2 = e10.headers.get("cookie") || "";
        if (!t2) return false;
        for (let e11 of tl) {
          let r2 = e11.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), n2 = RegExp(`(?:^|;\\s*)${r2}=([^;]+)`), i2 = t2.match(n2);
          if (i2 && i2[1] && i2[1].trim().length > 10) return true;
        }
        return false;
      }
      async function td(e10) {
        let { pathname: t2 } = e10.nextUrl;
        if (t2.startsWith("/_next") || t2.startsWith("/favicon") || /\.(svg|png|jpg|jpeg|gif|webp|ico|css|js|woff|woff2|ttf|map)$/.test(t2)) return z.next();
        let r2 = tu.some((e11) => t2.startsWith(e11));
        if ("/api/debug-mw" === t2) {
          let r3 = e10.headers.get("cookie") || "", n3 = [];
          return e10.cookies.getAll().forEach((e11) => n3.push(e11.name)), z.json({ hasSession: tc(e10), cookieHeader: r3.substring(0, 200), cookieNamesViaAPI: n3, pathname: t2 });
        }
        let n2 = tc(e10);
        if (!n2 && !r2) {
          let t3 = e10.nextUrl.clone();
          return t3.pathname = "/login", z.redirect(t3);
        }
        if (n2 && ("/login" === t2 || "/register" === t2)) {
          let t3 = e10.nextUrl.clone();
          return t3.pathname = "/dashboard", z.redirect(t3);
        }
        return z.next();
      }
      let tp = { matcher: ["/((?!_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)"] }, th = (Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 }), { ...i }), tg = th.middleware || th.default, tf = "/src/middleware";
      if ("function" != typeof tg) throw Object.defineProperty(Error(`The Middleware "${tf}" must export a \`middleware\` or a \`default\` function`), "__NEXT_ERROR_CODE", { value: "E120", enumerable: false, configurable: true });
      function tb(e10) {
        return ti({ ...e10, page: tf, handler: async (...e11) => {
          try {
            return await tg(...e11);
          } catch (i2) {
      ...
      (() => {
        var i = { 226: function(i2, a2) {
          !function(o2, s) {
            "use strict";
            var l = "function", u = "undefined", c = "object", d = "string", p = "major", h = "model", g = "name", f = "type", b = "vendor", v = "version", m = "architecture", _ = "console", w = "mobile", y = "tablet", x = "smarttv", E = "wearable", S = "embedded", O = "Amazon", R = "Apple", C = "ASUS", P = "BlackBerry", T = "Browser", N = "Chrome", I = "Firefox", k = "Google", M = "Huawei", A = "Microsoft", j = "Motorola", L = "Opera", D = "Samsung", q = "Sharp", U = "Sony", B = "Xiaomi", V = "Zebra", $ = "Facebook", z = "Chromium OS", G = "Mac OS", H = function(e2, t2) {
              var r2 = {};
...
var NextConfig = { "env": {}, "webpack": null, "eslint": { "ignoreDuringBuilds": true }, "typescript": { "ignoreBuildErrors": true, "tsconfigPath": "tsconfig.json" }, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [], "unoptimized": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/home/runner/work/RAC/RAC", "experimental": { "nodeMiddleware": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 0, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 3, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedRoutes": false, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "useEarlyImport": false, "viewTransition": false, "routerBFCache": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "dynamicIO": false, "inlineCss": false, "useCache": false, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-squlite-node", "@effect/sql-squlite-bun", "@effect/sql-squlite-wasm", "@effect/sql-squlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "Mediapartners-Google|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "turbopack": { "root": "/home/runner/work/RAC/RAC" } };
var BuildId = "eoyS8eUm4w9z_cXMGXrYr";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/approvals", "regex": "^/approvals(?:/)?$", "routeKeys": {}, "namedRegex": "^/approvals(?:/)?$" }, { "page": "/attendances", "regex": "^/attendances(?:/)?$", "routeKeys": {}, "namedRegex": "^/attendances(?:/)?$" }, { "page": "/awards/district-dashboard", "regex": "^/awards/district\\-dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/awards/district\\-dashboard(?:/)?$" }, { "page": "/awards/settings", "regex": "^/awards/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/awards/settings(?:/)?$" }, { "page": "/clubs", "regex": "^/clubs(?:/)?$", "routeKeys": {}, "namedRegex": "^/clubs(?:/)?$" }, { "page": "/clubs/accounts", "regex": "^/clubs/accounts(?:/)?$", "routeKeys": {}, "namedRegex": "^/clubs/accounts(?:/)?$" }, { "page": "/csv", "regex": "^/csv(?:/)?$", "routeKeys": {}, "namedRegex": "^/csv(?:/)?$" }, { "page": "/dashboard", "regex": "^/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard(?:/)?$" }, { "page": "/district/calendar", "regex": "^/district/calendar(?:/)?$", "routeKeys": {}, "namedRegex": "^/district/calendar(?:/)?$" }, { "page": "/district/dashboard", "regex": "^/district/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/district/dashboard(?:/)?$" }, { "page": "/district/events", "regex": "^/district/events(?:/)?$", "routeKeys": {}, "namedRegex": "^/district/events(?:/)?$" }, { "page": "/district/instagram", "regex": "^/district/instagram(?:/)?$", "routeKeys": {}, "namedRegex": "^/district/instagram(?:/)?$" }, { "page": "/district/reports", "regex": "^/district/reports(?:/)?$", "routeKeys": {}, "namedRegex": "^/district/reports(?:/)?$" }, { "page": "/emails/compose", "regex": "^/emails/compose(?:/)?$", "routeKeys": {}, "namedRegex": "^/emails/compose(?:/)?$" }, { "page": "/emails/history", "regex": "^/emails/history(?:/)?$", "routeKeys": {}, "namedRegex": "^/emails/history(?:/)?$" }, { "page": "/emails/templates", "regex": "^/emails/templates(?:/)?$", "routeKeys": {}, "namedRegex": "^/emails/templates(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/finance/annual-fees", "regex": "^/finance/annual\\-fees(?:/)?$", "routeKeys": {}, "namedRegex": "^/finance/annual\\-fees(?:/)?$" }, { "page": "/finance/donations", "regex": "^/finance/donations(?:/)?$", "routeKeys": {}, "namedRegex": "^/finance/donations(?:/)?$" }, { "page": "/finance/transactions", "regex": "^/finance/transactions(?:/)?$", "routeKeys": {}, "namedRegex": "^/finance/transactions(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }, { "page": "/meetings", "regex": "^/meetings(?:/)?$", "routeKeys": {}, "namedRegex": "^/meetings(?:/)?$" }, { "page": "/meetings/new", "regex": "^/meetings/new(?:/)?$", "routeKeys": {}, "namedRegex": "^/meetings/new(?:/)?$" }, { "page": "/meetings/reception", "regex": "^/meetings/reception(?:/)?$", "routeKeys": {}, "namedRegex": "^/meetings/reception(?:/)?$" }, { "page": "/members", "regex": "^/members(?:/)?$", "routeKeys": {}, "namedRegex": "^/members(?:/)?$" }, { "page": "/pending", "regex": "^/pending(?:/)?$", "routeKeys": {}, "namedRegex": "^/pending(?:/)?$" }, { "page": "/receipts", "regex": "^/receipts(?:/)?$", "routeKeys": {}, "namedRegex": "^/receipts(?:/)?$" }, { "page": "/register", "regex": "^/register(?:/)?$", "routeKeys": {}, "namedRegex": "^/register(?:/)?$" }, { "page": "/reports", "regex": "^/reports(?:/)?$", "routeKeys": {}, "namedRegex": "^/reports(?:/)?$" }, { "page": "/reset-password", "regex": "^/reset\\-password(?:/)?$", "routeKeys": {}, "namedRegex": "^/reset\\-password(?:/)?$" }, { "page": "/settings", "regex": "^/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/settings(?:/)?$" }, { "page": "/users", "regex": "^/users(?:/)?$", "routeKeys": {}, "namedRegex": "^/users(?:/)?$" }], "dynamic": [{ "page": "/api/attendances/[id]", "regex": "^/api/attendances/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/attendances/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/auth/[...nextauth]", "regex": "^/api/auth/(.+?)(?:/)?$", "routeKeys": { "nxtPnextauth": "nxtPnextauth" }, "namedRegex": "^/api/auth/(?<nxtPnextauth>.+?)(?:/)?$" }, { "page": "/api/clubs/[id]", "regex": "^/api/clubs/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/clubs/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/emails/templates/[id]", "regex": "^/api/emails/templates/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/emails/templates/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/finance/annual-fees/[id]", "regex": "^/api/finance/annual\\-fees/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/finance/annual\\-fees/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/finance/donations/[id]", "regex": "^/api/finance/donations/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/finance/donations/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/finance/transactions/[id]", "regex": "^/api/finance/transactions/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/finance/transactions/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/meetings/[id]", "regex": "^/api/meetings/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/meetings/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/members/[id]", "regex": "^/api/members/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/members/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/receipts/[id]", "regex": "^/api/receipts/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/receipts/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/users/[id]", "regex": "^/api/users/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/users/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/club/[slug]", "regex": "^/club/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/club/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/club/[slug]/dashboard", "regex": "^/club/([^/]+?)/dashboard(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/club/(?<nxtPslug>[^/]+?)/dashboard(?:/)?$" }, { "page": "/club/[slug]/login", "regex": "^/club/([^/]+?)/login(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/club/(?<nxtPslug>[^/]+?)/login(?:/)?$" }, { "page": "/club/[slug]/my/annual-fee", "regex": "^/club/([^/]+?)/my/annual\\-fee(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/club/(?<nxtPslug>[^/]+?)/my/annual\\-fee(?:/)?$" }, { "page": "/club/[slug]/my/attendance", "regex": "^/club/([^/]+?)/my/attendance(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/club/(?<nxtPslug>[^/]+?)/my/attendance(?:/)?$" }, { "page": "/club/[slug]/my/profile", "regex": "^/club/([^/]+?)/my/profile(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/club/(?<nxtPslug>[^/]+?)/my/profile(?:/)?$" }, { "page": "/club/[slug]/my/receipts", "regex": "^/club/([^/]+?)/my/receipts(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/club/(?<nxtPslug>[^/]+?)/my/receipts(?:/)?$" }, { "page": "/club/[slug]/my/receipts/[receiptId]/print", "regex": "^/club/([^/]+?)/my/receipts/([^/]+?)/print(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug", "nxtPreceiptId": "nxtPreceiptId" }, "namedRegex": "^/club/(?<nxtPslug>[^/]+?)/my/receipts/(?<nxtPreceiptId>[^/]+?)/print(?:/)?$" }, { "page": "/club/[slug]/schedule", "regex": "^/club/([^/]+?)/schedule(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/club/(?<nxtPslug>[^/]+?)/schedule(?:/)?$" }, { "page": "/meetings/[id]", "regex": "^/meetings/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/meetings/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/meetings/[id]/attendances", "regex": "^/meetings/([^/]+?)/attendances(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/meetings/(?<nxtPid>[^/]+?)/attendances(?:/)?$" }, { "page": "/meetings/[id]/edit", "regex": "^/meetings/([^/]+?)/edit(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/meetings/(?<nxtPid>[^/]+?)/edit(?:/)?$" }, { "page": "/meetings/[id]/report", "regex": "^/meetings/([^/]+?)/report(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/meetings/(?<nxtPid>[^/]+?)/report(?:/)?$" }, { "page": "/mu/[slug]", "regex": "^/mu/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/mu/(?<nxtPslug>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/register": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/register", "dataRoute": "/register.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/reset-password": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/reset-password", "dataRoute": "/reset-password.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/login": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/login", "dataRoute": "/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "33b4e3088566967848af972c34b0089e", "previewModeSigningKey": "2b3f991bc9b24310d246363c5ce0aa171f4708227b08f509191b506f1b3e3773", "previewModeEncryptionKey": "e67c6ceac365240b8a853b907a52a64621a153f9005a5285748fcd7bc43cfe07" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "eoyS8eUm4w9z_cXMGXrYr", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "83ol5ilZKVptcGoVcPNfvu59b47MR06Zfq0KFexCAmw=", "__NEXT_PREVIEW_MODE_ID": "33b4e3088566967848af972c34b0089e", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "e67c6ceac365240b8a853b907a52a64621a153f9005a5285748fcd7bc43cfe07", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "2b3f991bc9b24310d246363c5ce0aa171f4708227b08f509191b506f1b3e3773" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/approvals/route": "/api/approvals", "/api/attendances/[id]/route": "/api/attendances/[id]", "/api/attendances/route": "/api/attendances", "/api/auth/logout/route": "/api/auth/logout", "/api/auth/verify/route": "/api/auth/verify", "/api/auth/register/route": "/api/auth/register", "/api/awards/route": "/api/awards", "/api/club-accounts/route": "/api/club-accounts", "/api/clubs/[id]/route": "/api/clubs/[id]", "/api/clubs/public/route": "/api/clubs/public", "/api/clubs/route": "/api/clubs", "/api/csv/export/route": "/api/csv/export", "/api/district/route": "/api/district", "/api/emails/history/route": "/api/emails/history", "/api/emails/send-registration-complete/route": "/api/emails/send-registration-complete", "/api/emails/send/route": "/api/emails/send", "/api/emails/templates/[id]/route": "/api/emails/templates/[id]", "/api/emails/templates/route": "/api/emails/templates", "/api/finance/annual-fees/[id]/route": "/api/finance/annual-fees/[id]", "/api/finance/annual-fees/route": "/api/finance/annual-fees", "/api/finance/create-from-attendance/route": "/api/finance/create-from-attendance", "/api/finance/donations/[id]/route": "/api/finance/donations/[id]", "/api/finance/donations/route": "/api/finance/donations", "/api/finance/transactions/[id]/route": "/api/finance/transactions/[id]", "/api/finance/transactions/route": "/api/finance/transactions", "/api/meetings/[id]/route": "/api/meetings/[id]", "/api/meetings/route": "/api/meetings", "/api/members/[id]/route": "/api/members/[id]", "/api/members/profile/route": "/api/members/profile", "/api/members/route": "/api/members", "/api/my/attendance/route": "/api/my/attendance", "/api/receipts/route": "/api/receipts", "/api/receipts/[id]/route": "/api/receipts/[id]", "/api/reports/generate/route": "/api/reports/generate", "/api/reports/route": "/api/reports", "/api/settings/route": "/api/settings", "/api/users/[id]/route": "/api/users/[id]", "/api/users/route": "/api/users", "/favicon.ico/route": "/favicon.ico", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/page": "/", "/(auth)/login/page": "/login", "/(auth)/register/page": "/register", "/(auth)/reset-password/page": "/reset-password", "/(dashboard)/meetings/[id]/attendances/page": "/meetings/[id]/attendances", "/(dashboard)/meetings/[id]/page": "/meetings/[id]", "/(public)/club/[slug]/dashboard/page": "/club/[slug]/dashboard", "/(public)/club/[slug]/my/annual-fee/page": "/club/[slug]/my/annual-fee", "/(public)/club/[slug]/login/page": "/club/[slug]/login", "/(public)/club/[slug]/my/attendance/page": "/club/[slug]/my/attendance", "/(public)/club/[slug]/my/profile/page": "/club/[slug]/my/profile", "/(public)/club/[slug]/my/receipts/[receiptId]/print/page": "/club/[slug]/my/receipts/[receiptId]/print", "/(public)/club/[slug]/my/receipts/page": "/club/[slug]/my/receipts", "/(public)/club/[slug]/page": "/club/[slug]", "/(public)/mu/[slug]/page": "/mu/[slug]", "/(public)/club/[slug]/schedule/page": "/club/[slug]/schedule", "/(dashboard)/approvals/page": "/approvals", "/(auth)/pending/page": "/pending", "/(dashboard)/awards/district-dashboard/page": "/awards/district-dashboard", "/(dashboard)/clubs/accounts/page": "/clubs/accounts", "/(dashboard)/awards/settings/page": "/awards/settings", "/(dashboard)/csv/page": "/csv", "/(dashboard)/clubs/page": "/clubs", "/(dashboard)/district/calendar/page": "/district/calendar", "/(dashboard)/attendances/page": "/attendances", "/(dashboard)/district/events/page": "/district/events", "/(dashboard)/district/dashboard/page": "/district/dashboard", "/(dashboard)/emails/templates/page": "/emails/templates", "/(dashboard)/emails/compose/page": "/emails/compose", "/(dashboard)/district/instagram/page": "/district/instagram", "/(dashboard)/district/reports/page": "/district/reports", "/(dashboard)/finance/annual-fees/page": "/finance/annual-fees", "/(dashboard)/finance/donations/page": "/finance/donations", "/(dashboard)/emails/history/page": "/emails/history", "/(dashboard)/meetings/new/page": "/meetings/new", "/(dashboard)/meetings/[id]/edit/page": "/meetings/[id]/edit", "/(dashboard)/finance/transactions/page": "/finance/transactions", "/(dashboard)/meetings/[id]/report/page": "/meetings/[id]/report", "/(dashboard)/meetings/page": "/meetings", "/(dashboard)/meetings/reception/page": "/meetings/reception", "/(dashboard)/members/page": "/members", "/(dashboard)/settings/page": "/settings", "/(dashboard)/reports/page": "/reports", "/(dashboard)/users/page": "/users", "/(dashboard)/dashboard/page": "/dashboard", "/(dashboard)/receipts/page": "/receipts" };

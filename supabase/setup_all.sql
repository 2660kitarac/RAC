...
-- ============================================================
-- STEP 9: 管理者ユーザー登録
-- ※ Supabase Auth でユーザーを作成した後、
--   下記の YOUR_AUTH_USER_ID を実際のUIDに置き換えて実行してください
-- ============================================================

-- 【重要】以下の手順を先に行ってください：
-- 1. Supabase → Authentication → Users → Add user
-- 2. Email: hiro0413022@gmail.com
-- 3. Password: 任意（8文字以上）
-- 4. 「Auto Confirm User」にチェック
-- 5. 作成されたユーザーのUIDをコピー
-- 6. 下記の YOUR_AUTH_USER_ID をそのUIDに置き換えて実行
...
INSERT INTO users (
  ...
  'YOUR_AUTH_USER_ID',  -- ← ここをSupabaseで作成したUIDに変更
  '33333333-3333-3333-3333-333333333331',
  '11111111-1111-1111-1111-111111111111',
  '古川博庸',
  'hiro0413022@gmail.com',
  'system_owner',  -- 全権限の管理者
  'RAC',
  TRUE
